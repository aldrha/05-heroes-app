...
export const HeroPage = () => {
  ...
  const { data: superheroData, isError } = useQuery({
    queryKey: ['hero-information', 'idSlug', idSlug],
  ...
  return (
    <>
      {/* Breadcrumbs */}
      <CustomBreadcrumb currentPage={superheroData?.alias ?? 'Super Hero Information'} />
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="flex-1 text-center md:text-left">
                <div className="flex flex-wrap gap-2 justify-center md:justify-start mb-4">
                  <Badge className={`${getCategoryColor(superheroData?.category ?? 'hero')} text-white`}>{superheroData?.category}</Badge>
                  <Badge className={`${getStatusColor(superheroData?.status ?? 'alive')} text-white`}>{superheroData?.status}</Badge>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <Card className="text-center">
                  <CardContent className="pt-6">
                    ...
                    <div className="text-3xl font-bold text-red-600 mb-2">{superheroData?.strength ?? 0}</div>
                ...
                <Card className="text-center">
                  <CardContent className="pt-6">
                    ...
                    <div className="text-3xl font-bold text-purple-600 mb-2">{superheroData?.intelligence ?? 0}</div>
                ...
                <Card className="text-center">
                  <CardContent className="pt-6">
                    ...
                    <div className="text-3xl font-bold text-yellow-600 mb-2">{superheroData?.speed ?? 0}</div>
                ...
                <Card className="text-center">
                  <CardContent className="pt-6">
                    ...
                    <div className="text-3xl font-bold text-green-600 mb-2">{superheroData?.durability ?? 0}</div>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex justify-between items-center py-2">
                      ...
                      <span className="font-semibold">{new Date().getFullYear() - Number.parseInt(superheroData?.firstAppearance ?? '1990')} años</span>
                    </div>
                  </CardContent>
                </Card>
              </div>
