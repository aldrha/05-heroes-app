...
describe('useHeroSummary', () => {
  ...
  test('should call the Api and return success state and correct values', async () => {
    ...
    //
    expect(result.current.isError).toBe(false);
    expect(mockGetSummaryAction).toBeCalled();
  });

  test('should return error when state API call fails', async () => {
